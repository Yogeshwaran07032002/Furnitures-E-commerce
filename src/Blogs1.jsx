...
function Blogs1(){
    return(<div>
           {/* 1st page in section 111111111111 */}
           <div className="servicefirstpage1">
            
            <div className="modi">
            <div className="modblog">Blogs</div>
            <div className="duablog"> Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit. Aliquam vulputate velit imperdiet dolor tempor tristique.</div>
           <div className="shoping">Shop now</div>
            ...
            {/* page2222222 */}
            <div className="page66">
                <div className="blogborders">
            {/* <div className="bloimage"> */}
           <div className="bloimage11">
                <div className="blochar1"></div>
                <div className="text1">
                    <h6>First Time Home Owner Ideas  
                    <small> <br/>by</small> Kristin Watson  <small> on</small> Dec 19, 2021</h6>
                </div>
           </div>
           <div className="bloimage2">
                <div className="blochar2"></div>
                <div className="text2">
                    <h6>How To Keep Your Furniture Clean
                    <small> <br/>by</small> Robert Fox <small> on</small> Dec 15, 2021</h6>
               </div>
           </div>
           <div className="bloimage3">
                <div className="blochar3"></div>
                <div className="text3">
                    <h6>Small Space Furniture Apartment Ideas
                    <small> <br/>by</small> Kristin Watson  <small> on</small> Dec 19, 2021</h6>
               </div>
           </div>
       {/* </div> */}
